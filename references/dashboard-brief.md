...
In order: a roster became identities, identities became evidence, evidence became structure, and structure became a page — with every step attributable and every gap named. The charts are there to make that chain visible at a glance, not to decorate it.
