...
| --- | --- | --- | --- |
| `/people/retrieve` | POST | per plan | The core of this run. Resolves a **known** LinkedIn URL into a structured person: full name, headline, location, summary, experience, education, skills. Private alpha — confirm access before planning the cohort around it. |
